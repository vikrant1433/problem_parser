...
mkdir -p ${path}
cd ${path}
/home/vikrant/.py_envs/env_scrapping/bin/python3.4 ~/PycharmProjects/hackerrank/hackerrank/hackerrank.py "${contest_url}" > ${problem_link_file}
while IFS='' read -r problem_link || [[ -n "${problem_link}" ]]; do
    bash /home/vikrant/PycharmProjects/hackerrank/hackerrank/parse_hackerrank_problem.sh "${problem_link}"
